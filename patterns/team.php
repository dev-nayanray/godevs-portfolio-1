 ...
 */
?>
<!-- wp:group {"tagName":"section","className":"godevs-team","style":{"spacing":{"padding":{"top":"var:preset|spacing|90","bottom":"var:preset|spacing|90"}}},"layout":{"type":"constrained","contentSize":"var(--wp--style--global--wide-size)"}} -->
<section class="wp-block-group godevs-team" style="padding-top:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--90)">
	...
	<div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--70)">
		...
		<p class="is-style-eyebrow has-text-color" style="color:var(--wp--preset--color--accent);text-transform:uppercase;letter-spacing:0.12em;font-weight:600">People</p>
		<!-- /wp:paragraph -->
		...
		<h2 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--xx-large);line-height:1.05;letter-spacing:-0.03em;font-weight:700">A small team, <em style="font-family:var(--wp--preset--font-family--serif);font-style:italic;font-weight:500">by design</em>.</h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->

	<!-- wp:group {"align":"wide","className":"godevs-grid-3 godevs-reveal-stagger","style":{"spacing":{"blockGap":"var:preset|spacing|50"}},"layout":{"type":"grid","columnCount":3}} -->
	<div class="wp-block-group alignwide godevs-grid-3 godevs-reveal-stagger">
		<!-- wp:group {"className":"is-style-card-pro","style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
		<div class="wp-block-group is-style-card-pro">
			<!-- wp:group {"style":{"dimensions":{"width":"96px","height":"96px"},"spacing":{"blockGap":"var:preset|spacing|20"}},"backgroundColor":"surface-muted","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center","verticalAlignment":"center"}} -->
			<div class="wp-block-group has-surface-muted-background-color has-background" style="width:96px;height:96px;border-radius:999px">
				<!-- wp:paragraph {"style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"var:preset|font-size|large","fontWeight":"700","letterSpacing":"-0.02em"}}} -->
				<p style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--large);font-weight:700;letter-spacing:-0.02em">M</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:heading {"level":3,"style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"var:preset|font-size|large","lineHeight":"1.15","letterSpacing":"-0.02em","fontWeight":"700"},"spacing":{"margin":{"top":"var:preset|spacing|20"}}}} -->
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"fontSize":"x-small","style":{"typography":{"letterSpacing":"0.04em"},"color":{"text":"var:preset|color|muted"}}} -->
			<p class="has-x-small-font-size has-text-color" style="color:var(--wp--preset--color--muted);letter-spacing:0.04em"><a href="#">LinkedIn</a> · <a href="#">Website</a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group is-style-card-pro">
			...
			<div class="wp-block-group has-surface-muted-background-color has-background" style="width:96px;height:96px;border-radius:999px">
				<!-- wp:paragraph {"style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"var:preset|font-size|large","fontWeight":"700","letterSpacing":"-0.02em"}}} -->
				<p style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--large);font-weight:700;letter-spacing:-0.02em">T</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:heading {"level":3,"style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"var:preset|font-size|large","lineHeight":"1.15","letterSpacing":"-0.02em","fontWeight":"700"},"spacing":{"margin":{"top":"var:preset|spacing|20"}}}} -->
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"fontSize":"x-small","style":{"typography":{"letterSpacing":"0.04em"},"color":{"text":"var:preset|color|muted"}}} -->
			<p class="has-x-small-font-size has-text-color" style="color:var(--wp--preset--color--muted);letter-spacing:0.04em"><a href="#">GitHub</a> · <a href="#">LinkedIn</a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group is-style-card-pro">
			...
			<div class="wp-block-group has-surface-muted-background-color has-background" style="width:96px;height:96px;border-radius:999px">
				<!-- wp:paragraph {"style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"var:preset|font-size|large","fontWeight":"700","letterSpacing":"-0.02em"}}} -->
				<p style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size--large);font-weight:700;letter-spacing:-0.02em">P</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:heading {"level":3,"style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"var:preset|font-size|large","lineHeight":"1.15","letterSpacing":"-0.02em","fontWeight":"700"},"spacing":{"margin":{"top":"var:preset|spacing|20"}}}} -->
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"fontSize":"x-small","style":{"typography":{"letterSpacing":"0.04em"},"color":{"text":"var:preset|color|muted"}}} -->
			<p class="has-x-small-font-size has-text-color" style="color:var(--wp--preset--color--muted);letter-spacing:0.04em"><a href="#">LinkedIn</a> · <a href="#">Writing</a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>
