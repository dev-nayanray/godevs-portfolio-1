 ...
 */
?>
<!-- wp:group {"tagName":"section","className":"godevs-about","style":{"spacing":{"padding":{"top":"var:preset|spacing|90","bottom":"var:preset|spacing|90"}}},"layout":{"type":"constrained","contentSize":"var(--wp--style--root--wide-size)"}} -->
<section class="wp-block-group godevs-about" style="padding-top:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--90)">
	<!-- wp:group {"align":"wide","layout":{"type":"default"}} -->
	<div class="wp-block-group alignwide">

		<!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|70","top":"var:preset|spacing|70"}}}} -->
		<div class="wp-block-columns are-vertically-aligned-center">
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:60%">
				...
				<p class="has-text-color" style="color:var(--wp--preset--color--secondary);font-size:var(--wp--preset--font-size--normal);line-height:1.7;margin-top:var(--wp--preset--spacing--40)">The method has not changed much in a decade: write the brief, design the system, build it into the block editor, then hand over the keys. Fewer moving parts, better work, calmer clients.</p>
				<!-- /wp:paragraph -->
				...
				<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--50)">
					<!-- wp:paragraph {"style":{"border":{"radius":"var(--wp--custom--radius--pill, 9999px)","width":"1px","color":"var:preset|color|border","style":"solid"},"spacing":{"padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}},"typography":{"fontSize":"var:preset|font-size|small","letterSpacing":"0.04em","fontWeight":"500","textTransform":"uppercase"},"color":{"text":"var:preset|color|secondary"}}} -->
					<p class="has-text-color" style="color:var(--wp--preset--color--secondary);border-radius:var(--wp--custom--radius--pill, 9999px);border-color:var(--wp--preset--color--border);border-style:solid;border-width:1px;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--40);font-size:var(--wp--preset--font-size--small);letter-spacing:0.04em;font-weight:500;text-transform:uppercase">Est. 2014</p>
					<!-- /wp:paragraph -->
					...
					<!-- wp:paragraph {"style":{"border":{"radius":"var(--wp--custom--radius--pill, 9999px)","width":"1px","color":"var:preset|color|border","style":"solid"},"spacing":{"padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}},"typography":{"fontSize":"var:preset|font-size|small","letterSpacing":"0.04em","fontWeight":"500","textTransform":"uppercase"},"color":{"text":"var:preset|color|secondary"}}} -->
					<p class="has-text-color" style="color:var(--wp--preset--color--secondary);border-radius:var(--wp--custom--radius--pill, 9999px);border-color:var(--wp--preset--color--border);border-style:solid;border-width:1px;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--40);font-size:var(--wp--preset--font-size--small);letter-spacing:0.04em;font-weight:500;text-transform:uppercase">4 continents</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			...
			<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%">
				<!-- wp:group {"style":{"spacing":{"blockGap":"0","margin":{"top":"var:preset|spacing|60"}}},"layout":{"type":"default"}} -->
				<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--60)">
					...
					<!-- wp:group {"style":{"border":{"radius":"var(--wp--custom--radius--lg, 12px)","width":"1px","color":"var:preset|color|accent","style":"solid"},"spacing":{"margin":{"top":"calc(-1 * var(--wp--preset--spacing--70))","left":"var:preset|spacing|60"},"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}},"color":{"background":"var:preset|color|surface"}},"layout":{"type":"constrained"}} -->
					<div class="wp-block-group has-background" style="background-color:var(--wp--preset--color--surface);border-color:var(--wp--preset--color--accent);border-style:solid;border-width:1px;border-radius:var(--wp--custom--radius--lg, 12px);margin-top:calc(-1 * var(--wp--preset--spacing--70));margin-left:var(--wp--preset--spacing--60);padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--50)">
						...
						<p class="has-text-color" style="color:var(--wp--preset--color--primary);font-size:var(--wp--preset--font-size--normal);line-height:1.5;font-weight:500;margin-top:var(--wp--preset--spacing--20)">Creative director, ex-agency. Ten years of editorial systems, now applied to WordPress full time.</p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
				</div>
