                ...
                <div class="wp-block-cover__inner-container" style="padding-top:var(--wp--preset--spacing--100);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
                        ...
                        <div class="wp-block-group alignwide">
                                ...
                                <div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--60)">
                                        ...
                                        <div class="wp-block-button"><a href="/" class="wp-block-button__link wp-element-button" style="border-radius:0;font-size:0.6875rem;font-weight:600;letter-spacing:0.2em">Back to home →</a></div>
                                        <!-- /wp:button -->
                                        ...
                                        <div class="wp-block-button is-style-outline"><a href="#showreel" class="wp-block-button__link wp-element-button" style="border-radius:0;font-size:0.6875rem;font-weight:600;letter-spacing:0.2em">Watch the reel</a></div>
                                        <!-- /wp:button -->
                                </div>
                                <!-- /wp:buttons -->
