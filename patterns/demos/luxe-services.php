...
<section class="wp-block-group wp-block-godevs-demo-luxe alignfull">
		...
		<div class="wp-block-group alignwide">
			...
			<div class="wp-block-columns are-vertically-aligned-bottom">
				...
				<div class="wp-block-column" style="flex-basis:62%">
					<!-- wp:heading {"level":1,"className":"luxe-display","style":{"typography":{"fontFamily":"var:preset|font-family|display","fontWeight":"400","letterSpacing":"-0.025em","lineHeight":"1.0","fontSize":"clamp(3rem, 9vw, 8rem)"}}} -->
					<h1 class="wp-block-heading luxe-display" style="font-family:var(--wp--preset--font-family--display);font-weight:400;letter-spacing:-0.025em;line-height:1.0;font-size:clamp(3rem, 9vw, 8rem)">Capabilities.</h1>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:column -->
	...
	<section class="wp-block-group alignfull" style="border-top-color:var(--wp--preset--color--line);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--100);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
		...
		<div class="wp-block-group alignwide">
			...
			<!-- wp:html -->
			<div>
				<a class="luxe-service-row" href="/services" style="grid-template-columns: 3rem 1fr 22rem auto;">
				...
				<a class="luxe-service-row" href="/services" style="grid-template-columns: 3rem 1fr 22rem auto;">
					<span class="luxe-service-num">07</span>
					<span class="luxe-service-title">Visual Identity</span>
					<span class="luxe-service-desc">Brand identity for fashion houses and ateliers.</span>
					<span class="luxe-service-arrow" aria-hidden="true">→</span>
				</a>
			</div>
			<!-- /wp:html -->
	...
	<section class="wp-block-group alignfull" style="border-top-color:var(--wp--preset--color--line);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--100);padding-bottom:var(--wp--preset--spacing--100);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
		...
		<div class="wp-block-group alignwide">
			...
			<h2 class="wp-block-heading luxe-display" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.25rem, 5vw, 4rem);line-height:1.05;letter-spacing:-0.02em;font-weight:400">The first <span class="luxe-italic">idea.</span></h2>
			<!-- /wp:heading -->

			<!-- Image + text split -->
			<!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|60"},"blockGap":"var:preset|spacing|70"}}} -->
	...
	<section class="wp-block-group alignfull" style="border-top-color:var(--wp--preset--color--line);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--100);padding-bottom:var(--wp--preset--spacing--100);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
		...
		<div class="wp-block-group alignwide">
			...
			<!-- H2 -->
			<!-- wp:heading {"level":2,"className":"luxe-display","style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"clamp(2.25rem, 5vw, 4rem)","lineHeight":"1.05","letterSpacing":"-0.02em","fontWeight":"400"}}} -->
			<h2 class="wp-block-heading luxe-display" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.25rem, 5vw, 4rem);line-height:1.05;letter-spacing:-0.02em;font-weight:400">From sketch to <span class="luxe-italic">garment.</span></h2>
			<!-- /wp:heading -->
	...
	<section class="wp-block-group alignfull" style="border-top-color:var(--wp--preset--color--line);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--100);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
		...
		<div class="wp-block-group alignwide">
			...
			<!-- wp:html -->
			<div>
				<a class="luxe-service-row" href="/services" style="grid-template-columns: 3rem 1fr 24rem auto;">
					<span class="luxe-service-num">01</span>
					<span class="luxe-service-title">Concept</span>
					<span class="luxe-service-desc">Research, references, mood, silhouette logic.</span>
					<span class="luxe-service-arrow" aria-hidden="true">→</span>
				</a>
				<a class="luxe-service-row" href="/services" style="grid-template-columns: 3rem 1fr 24rem auto;">
					<span class="luxe-service-num">02</span>
					<span class="luxe-service-title">Design</span>
					<span class="luxe-service-desc">Sketches, flat patterns, toiles, fittings.</span>
					<span class="luxe-service-arrow" aria-hidden="true">→</span>
				</a>
				<a class="luxe-service-row" href="/services" style="grid-template-columns: 3rem 1fr 24rem auto;">
					<span class="luxe-service-num">03</span>
					<span class="luxe-service-title">Production</span>
					<span class="luxe-service-desc">Fabric sourcing, atelier finishing, final pieces.</span>
					<span class="luxe-service-arrow" aria-hidden="true">→</span>
				</a>
				<a class="luxe-service-row" href="/services" style="grid-template-columns: 3rem 1fr 24rem auto;">
					<span class="luxe-service-num">04</span>
					<span class="luxe-service-title">Image</span>
					<span class="luxe-service-desc">Campaign, editorial, lookbook, final image.</span>
					<span class="luxe-service-arrow" aria-hidden="true">→</span>
				</a>
			</div>
			<!-- /wp:html -->
	...
	<section class="wp-block-group alignfull" style="border-top-color:var(--wp--preset--color--line);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--100);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
		...
		<div class="wp-block-group alignwide">
			...
			<p class="luxe-statement" style="font-family:var(--wp--preset--font-family--display);font-style:italic;font-size:clamp(1.75rem, 3.5vw, 2.75rem);line-height:1.2;letter-spacing:-0.01em;font-weight:400;max-width:30ch">If your project fits the practice, the next step is a conversation.</p>
			<!-- /wp:paragraph -->
			...
			<p style="margin-top:var(--wp--preset--spacing--50);font-family:var(--wp--preset--font-family--display);font-style:italic;font-size:1.0625rem"><a href="/contact">Make an inquiry →</a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</section>
