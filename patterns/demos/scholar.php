		...
		<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
			...
			<div class="wp-block-columns are-vertically-aligned-center">
				...
				<div class="wp-block-column" style="flex-basis:58%">
					...
					<div class="wp-block-buttons" style="margin-bottom:var(--wp--preset--spacing--20)">
	...
	<section class="wp-block-group alignfull has-surface-muted-background-color has-background">
		...
		<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
			...
			<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--60)">
				...
				<h2 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--serif);font-size:var(--wp--preset--font-size|xx-large);letter-spacing:-0.02em;font-weight:400">Selected publications.</h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:group -->
			...
			<p style="margin-top:var(--wp--preset--spacing--40);font-size:var(--wp--preset--font-size--small)"><a href="#research">View all research →</a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</section>
