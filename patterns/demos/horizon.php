                ...
                <div class="wp-block-cover__inner-container" style="padding-top:var(--wp--preset--spacing--100);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
                        ...
                        <div class="wp-block-group alignwide">
                                ...
                                <div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--50)">
                                        ...
                                        <div class="wp-block-button"><a href="/journey" class="wp-block-button__link wp-element-button" style="border-radius:0;font-size:0.6875rem;font-weight:500;letter-spacing:0.18em;text-transform:uppercase">Explore Journey →</a></div>
                                        <!-- /wp:button -->
                                        ...
                                        <div class="wp-block-button is-style-hor-outline"><a href="/photography" class="wp-block-button__link wp-element-button" style="border-radius:0;font-size:0.6875rem;font-weight:500;letter-spacing:0.18em;text-transform:uppercase">View Photography</a></div>
                                        <!-- /wp:button -->
                                </div>
                                <!-- /wp:buttons -->
