                        ...
                        <div class="wp-block-columns are-vertically-aligned-bottom" style="margin-top:var(--wp--preset--spacing--70)">
                                ...
                                <div class="wp-block-column" style="flex-basis:44%">
                                        ...
                                        <div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--50)">
                                                ...
                                                <div class="wp-block-button"><a href="/work" class="wp-block-button__link wp-element-button" style="border-radius:4px;font-size:0.875rem;font-weight:500">View Work →</a></div>
                                                <!-- /wp:button -->
                                                <!-- wp:button {"className":"is-style-outline","style":{"border":{"radius":"4px"},"typography":{"fontSize":"0.875rem","fontWeight":"500"}}} -->
                                                <div class="wp-block-button is-style-outline"><a href="/about" class="wp-block-button__link wp-element-button" style="border-radius:4px;font-size:0.875rem;font-weight:500">About Me →</a></div>
                                                <!-- /wp:button -->
                                        </div>
                                        <!-- /wp:buttons -->
                                </div>
