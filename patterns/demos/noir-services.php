...
<section class="wp-block-group wp-block-godevs-demo-noir alignfull">
        ...
        <section class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--120);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
                ...
                <div class="wp-block-group alignwide" style="max-width:88ch">
                        ...
                        <h1 class="wp-block-heading noir-display has-text-color" style="color:var(--wp--preset--color--contrast);font-family:var(--wp--preset--font-family--display);font-weight:700;letter-spacing:-0.035em;line-height:0.98;font-size:clamp(3rem, 8vw, 8rem)">What I <span class="noir-accent-text">direct.</span></h1>
                        <!-- /wp:heading -->
                                        ...
                                        <a class="noir-film" href="#" style="display:block; aspect-ratio: 4/5;" aria-label="View commercial film — Afterlight">
                                                <div class="noir-film-media">
                                                        ...
                                                        <div class="noir-film-overlay">
                                                                ...
                                                                <p class="noir-film-meta"><span>Commercial</span><span>2026</span></p>
                                                        </div>
                                                </div>
                                        </a>
                                        <!-- /wp:html -->
                ...
                <div class="wp-block-group alignwide">
                        ...
                        <div class="wp-block-columns">
                                ...
                                <div class="wp-block-column" style="flex-basis:70%">
                                        <!-- wp:heading {"level":2,"className":"noir-display","style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"clamp(2.25rem, 5vw, 4rem)","lineHeight":"1.0","letterSpacing":"-0.03em","fontWeight":"700"}}} -->
                                        <h2 class="wp-block-heading noir-display" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2.25rem, 5vw, 4rem);line-height:1.0;letter-spacing:-0.03em;font-weight:700">Four phases.</h2>
                                        <!-- /wp:heading -->
                                </div>
                                <!-- /wp:column -->
                        </div>
                        ...
                        <div style="margin-top: 3rem;">
                                <a class="noir-service-row" href="/contact">
                                        <span class="noir-service-num">01</span>
                                        <span class="noir-service-title">Concept</span>
                                        <span class="noir-service-desc">References, script, treatment, scope.</span>
                                        <span class="noir-service-arrow" aria-hidden="true">→</span>
                                </a>
                                <a class="noir-service-row" href="/contact">
                                        <span class="noir-service-num">02</span>
                                        <span class="noir-service-title">Pre-production</span>
                                        <span class="noir-service-desc">Crew, locations, casting, schedule.</span>
                                        <span class="noir-service-arrow" aria-hidden="true">→</span>
                                </a>
                                <a class="noir-service-row" href="/contact">
                                        <span class="noir-service-num">03</span>
                                        <span class="noir-service-title">Production</span>
                                        <span class="noir-service-desc">Principal photography, on-set direction.</span>
                                        <span class="noir-service-arrow" aria-hidden="true">→</span>
                                </a>
                                <a class="noir-service-row" href="/contact">
                                        <span class="noir-service-num">04</span>
                                        <span class="noir-service-title">Post</span>
                                        <span class="noir-service-desc">Edit, color, sound, delivery.</span>
                                        <span class="noir-service-arrow" aria-hidden="true">→</span>
                                </a>
                        </div>
                        <!-- /wp:html -->
