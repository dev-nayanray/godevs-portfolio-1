 ...
 * Description: About page for the Northbound demo. Independent consultant bio, principles, and ways of working. Recommended style variation: Dark.
...
<p class="is-style-eyebrow has-text-color" style="color:var(--wp--preset--color--contrast)">About</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading has-text-color" style="color:var(--wp--preset--color--contrast);font-family:var(--wp--preset--font-family--display);font-size:clamp(2rem, 5vw, 3.5rem);line-height:1.1;letter-spacing:-0.025em;font-weight:600">An independent consultant.</h1>
<!-- /wp:heading -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--contrast);font-size:var(--wp--preset--font-size|medium);line-height:1.7;max-width:560px">I'm Ingrid Voss, a strategy &amp; delivery consultant with 12 years in the field — first in-house, now independent. I work with leadership teams who know what "good" looks like and need help getting there.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</section>
...
<h2 class="wp-block-heading" style="font-family:var(--wp--preset--font-family--display);font-size:var(--wp--preset--font-size|x-large);letter-spacing:-0.02em;font-weight:600">How I work.</h2>
<!-- /wp:heading -->
