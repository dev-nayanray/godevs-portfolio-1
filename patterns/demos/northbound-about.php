...
<p class="has-text-color" style="color:var(--wp--preset--color--contrast);font-size:var(--wp--preset--font-size|medium);line-height:1.7;max-width:560px">Northbound is a small studio working with brands that want to be remembered. We do strategy, identity, and digital production — all under one roof, with no handoff gaps.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</section>
