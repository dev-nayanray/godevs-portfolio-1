<?php
/**
 * Title: Demo — Mono (Developer) — Stack
 * Slug: godevs-portfolio/demo-mono-stack
 * Description: MONO stack — technologies, tools, workflow. Recommended style variation: Mono.
 * Categories: godevs-portfolio-demos
 * Keywords: demo, mono, stack, technologies
 * Viewport Width: 1440
 */
	...
	<section class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
		...
		<div class="wp-block-group alignwide">
			...
			<div class="wp-block-group">
				...
				<p class="is-style-mono-label has-text-color" style="color:var(--wp--preset--color--muted);font-family:var(--wp--preset--font-family--mono);font-size:0.75rem;letter-spacing:0.01em;font-weight:500">5 disciplines · 19 tools · 2026</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<h1 class="wp-block-heading mono-display" style="font-family:var(--wp--preset--font-family--display);font-weight:600;letter-spacing:-0.03em;line-height:1.0;font-size:clamp(2.5rem, 8vw, 7.5rem)">Tools I <span class="mono-accent-text">work with.</span></h1>
			<!-- /wp:heading -->
			...
			<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--medium);line-height:1.6;margin-top:var(--wp--preset--spacing--40);max-width:60ch">A pragmatic stack. I prefer tools that are durable, well-documented and a pleasure to maintain — not the newest thing. Below is what I reach for in 2026.</p>
			<!-- /wp:paragraph -->
	...
	<section class="wp-block-group alignfull" style="border-top-color:var(--wp--preset--color--line);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--100);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
		...
		<div class="wp-block-group alignwide">
			...
			<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--60)">
				<!-- wp:paragraph {"className":"is-style-mono-label","style":{"typography":{"fontFamily":"var:preset|font-family|mono","fontSize":"0.75rem","letterSpacing":"0.01em","fontWeight":"500"},"color":{"text":"var:preset|color|muted"}}} -->
				<p class="is-style-mono-label has-text-color" style="color:var(--wp--preset--color--muted);font-family:var(--wp--preset--font-family--mono);font-size:0.75rem;letter-spacing:0.01em;font-weight:500">— Disciplines</p>
				<!-- /wp:paragraph -->
				...
				<h2 class="wp-block-heading mono-display" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2rem, 4.5vw, 3.5rem);line-height:1.05;letter-spacing:-0.025em;font-weight:600">Five disciplines, one stack.</h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:group -->
			...
			<div>
				...
				<div class="mono-stack-group">
					<p class="mono-stack-label">Design</p>
					<div class="mono-stack-list">
						<span>Figma</span><span>Design Systems</span><span>Prototyping</span>
					</div>
				</div>
			</div>
			<!-- /wp:html -->
		...
		<div class="wp-block-group alignwide">
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column" style="flex-basis:30%">
					<!-- wp:paragraph {"className":"is-style-mono-label","style":{"typography":{"fontFamily":"var:preset|font-family|mono","fontSize":"0.75rem","letterSpacing":"0.01em","fontWeight":"500"},"color":{"text":"var:preset|color|muted"}}} -->
					<p class="is-style-mono-label has-text-color" style="color:var(--wp--preset--color--muted);font-family:var(--wp--preset--font-family--mono);font-size:0.75rem;letter-spacing:0.01em;font-weight:500">— Workflow</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:column -->
				<!-- wp:column {"width":"70%"} -->
				<div class="wp-block-column" style="flex-basis:70%">
					<!-- wp:heading {"level":2,"className":"mono-display","style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"clamp(2rem, 4.5vw, 3.5rem)","lineHeight":"1.05","letterSpacing":"-0.025em","fontWeight":"600"}}} -->
					<h2 class="wp-block-heading mono-display" style="font-family:var(--wp--preset--font-family--display);font-size:clamp(2rem, 4.5vw, 3.5rem);line-height:1.05;letter-spacing:-0.025em;font-weight:600">How a project moves.</h2>
					<!-- /wp:heading -->
					...
					<p class="has-text-color" style="color:var(--wp--preset--color--muted);font-size:var(--wp--preset--font-size--medium);line-height:1.65;margin-top:var(--wp--preset--spacing--30);max-width:58ch">Every engagement moves through the same six beats — discover, architect, build, test, ship, improve. Each one is reversible, observable, and the next is never far away.</p>
					<!-- /wp:paragraph -->

					<!-- Workflow as numbered steps (mono-row) -->
					<!-- wp:html -->
					<div style="margin-top: 2rem;">
						<div class="mono-row" style="text-decoration: none;">
							<span class="mono-row-num">01</span>
							<span class="mono-row-title">Discover</span>
							<span class="mono-row-desc">Understand the problem, the users, the constraints.</span>
							<span class="mono-row-arrow" aria-hidden="true">—</span>
						</div>
						<div class="mono-row" style="text-decoration: none;">
							<span class="mono-row-num">02</span>
							<span class="mono-row-title">Architect</span>
							<span class="mono-row-desc">Sketch the system — data model, API, surfaces, edges.</span>
							<span class="mono-row-arrow" aria-hidden="true">—</span>
						</div>
						<div class="mono-row" style="text-decoration: none;">
							<span class="mono-row-num">03</span>
							<span class="mono-row-title">Build</span>
							<span class="mono-row-desc">Implement in small, reversible increments.</span>
							<span class="mono-row-arrow" aria-hidden="true">—</span>
						</div>
						<div class="mono-row" style="text-decoration: none;">
							<span class="mono-row-num">04</span>
							<span class="mono-row-title">Test</span>
							<span class="mono-row-desc">Automated tests, accessibility, performance budgets.</span>
							<span class="mono-row-arrow" aria-hidden="true">—</span>
						</div>
						<div class="mono-row" style="text-decoration: none;">
							<span class="mono-row-num">05</span>
							<span class="mono-row-title">Ship</span>
							<span class="mono-row-desc">Deploy behind flags, monitor, roll out gradually.</span>
							<span class="mono-row-arrow" aria-hidden="true">—</span>
						</div>
						<div class="mono-row" style="text-decoration: none;">
							<span class="mono-row-num">06</span>
							<span class="mono-row-title">Improve</span>
							<span class="mono-row-desc">Measure, refine, document — then loop.</span>
							<span class="mono-row-arrow" aria-hidden="true">—</span>
						</div>
					</div>
					<!-- /wp:html -->
...
<span class="mono-code-accent">discover</span> → <span class="mono-code-accent">architect</span> → <span class="mono-code-accent">build</span> → <span class="mono-code-accent">test</span> → <span class="mono-code-accent">ship</span> → <span class="mono-code-accent">improve</span>
					</div>
					<!-- /wp:html -->
				</div>
				<!-- /wp:column -->
	...
	<!-- ═══ 04 — CODE ACCENT (architecture diagram) ═══ -->
	...
	<section class="wp-block-group mono-dark alignfull has-contrast-color has-primary-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--100);padding-bottom:var(--wp--preset--spacing--100);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
		...
		<div class="wp-block-group alignwide">
			...
			<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--50)">
				<!-- wp:paragraph {"className":"is-style-mono-label","style":{"typography":{"fontFamily":"var:preset|font-family|mono","fontSize":"0.75rem","letterSpacing":"0.01em","fontWeight":"500"},"color":{"text":"var:preset|color|accent"}}} -->
				<p class="is-style-mono-label has-text-color" style="color:var(--wp--preset--color--accent);font-family:var(--wp--preset--font-family--mono);font-size:0.75rem;letter-spacing:0.01em;font-weight:500">— Architecture</p>
				<!-- /wp:paragraph -->
				<!-- wp:heading {"level":2,"className":"mono-display","style":{"typography":{"fontFamily":"var:preset|font-family|display","fontSize":"clamp(2rem, 4.5vw, 3.5rem)","lineHeight":"1.05","letterSpacing":"-0.025em","fontWeight":"600"},"color":{"text":"var:preset|color|contrast"}}} -->
				<h2 class="wp-block-heading mono-display has-text-color" style="color:var(--wp--preset--color--contrast);font-family:var(--wp--preset--font-family--display);font-size:clamp(2rem, 4.5vw, 3.5rem);line-height:1.05;letter-spacing:-0.025em;font-weight:600">A typical request lifecycle.</h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:group -->
			...
			<!-- wp:html -->
			<div class="mono-code">
<span class="mono-code-muted">// request lifecycle — typed end to end</span>
<span class="mono-code-accent">client</span> → <span class="mono-code-accent">edge</span> → <span class="mono-code-accent">api</span> → <span class="mono-code-accent">service</span> → <span class="mono-code-accent">postgres</span> / <span class="mono-code-accent">redis</span>

<span class="mono-code-muted">// invariants</span>
<span class="mono-code-accent">type-safe</span> at every boundary  ·  <span class="mono-code-accent">observable</span> by default  ·  <span class="mono-code-accent">reversible</span> on demand
			</div>
			<!-- /wp:html -->
			...
			<div class="wp-block-columns" style="margin-top:var(--wp--preset--spacing--70)">
				...
				<div class="wp-block-column">
					...
					<p class="has-text-color" style="color:var(--wp--preset--color--contrast);font-size:var(--wp--preset--font-size--small);line-height:1.65">Next.js + React, typed queries, design tokens as a versioned package.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:column -->
				<!-- wp:column -->
				<div class="wp-block-column">
					...
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small","lineHeight":"1.65"},"color":{"text":"var:preset|color|contrast"}}} -->
					<p class="has-text-color" style="color:var(--wp--preset--color--contrast);font-size:var(--wp--preset--font-size--small);line-height:1.65">Node.js + Fastify, Zod-validated input, structured logging, OpenAPI.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:column -->
				<!-- wp:column -->
				<div class="wp-block-column">
					...
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|small","lineHeight":"1.65"},"color":{"text":"var:preset|color|contrast"}}} -->
					<p class="has-text-color" style="color:var(--wp--preset--color--contrast);font-size:var(--wp--preset--font-size--small);line-height:1.65">Postgres for truth, Redis for hot reads, Prisma migrations, every query timed.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:column -->
			</div>
