...
<section class="wp-block-group wp-block-godevs-demo-atelier alignfull">
                ...
                <div class="wp-block-group alignwide">
                        ...
                        <div class="wp-block-columns are-vertically-aligned-bottom" style="margin-top:var(--wp--preset--spacing--40)">
                                ...
                                <div class="wp-block-column" style="flex-basis:72%">
                                        <!-- wp:heading {"level":1,"className":"atelier-display","style":{"typography":{"fontFamily":"var:preset|font-family|display","fontWeight":"400","letterSpacing":"-0.02em","lineHeight":"1.0","fontSize":"clamp(3rem, 9vw, 9rem)"}}} -->
                                        <h1 class="wp-block-heading atelier-display" style="font-family:var(--wp--preset--font-family--display);font-weight:400;letter-spacing:-0.02em;line-height:1.0;font-size:clamp(3rem, 9vw, 9rem)">Lost in the <span class="atelier-italic">margin.</span></h1>
                                        <!-- /wp:heading -->
                                </div>
                                <!-- /wp:column -->
        ...
        <section class="wp-block-group alignfull" style="border-top-color:var(--wp--preset--color--line);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--120);padding-left:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60)">
                ...
                <div class="wp-block-group alignwide">
                        ...
                        <!-- Navigation buttons -->
                        <!-- wp:html -->
                        <nav class="atelier-404-nav" aria-label="Return navigation" style="display:grid;grid-template-columns:1fr;gap:1.5rem;">
                                <a href="/" style="display:flex;justify-content:space-between;align-items:baseline;gap:1.5rem;text-decoration:none;color:var(--atelier-ink);padding:2rem 0;border-top:1px solid var(--atelier-ink);transition:padding 0.5s cubic-bezier(0.2, 0.8, 0.2, 1);">
                                        <span style="font-family:var(--wp--preset--font-family--display);font-weight:400;font-size:clamp(1.75rem, 4vw, 2.75rem);line-height:1.05;letter-spacing:-0.015em;transition:color 0.4s ease, font-style 0.4s ease;">Back to home</span>
                                        <span style="display:flex;flex-direction:column;align-items:flex-end;gap:0.4rem;">
                                                <span class="is-style-atelier-label" style="font-family:var(--wp--preset--font-family--body);font-size:0.6875rem;letter-spacing:0.18em;text-transform:uppercase;color:var(--atelier-muted);font-weight:500;">Index</span>
                                                <span aria-hidden="true" style="font-family:var(--wp--preset--font-family--display);font-style:italic;font-size:clamp(1.5rem, 3vw, 2rem);color:var(--atelier-muted);transition:transform 0.4s cubic-bezier(0.2, 0.8, 0.2, 1), color 0.4s ease;">→</span>
                                        </span>
                                </a>
                                <a href="/work" style="display:flex;justify-content:space-between;align-items:baseline;gap:1.5rem;text-decoration:none;color:var(--atelier-ink);padding:2rem 0;border-top:1px solid var(--atelier-ink);border-bottom:1px solid var(--atelier-line);transition:padding 0.5s cubic-bezier(0.2, 0.8, 0.2, 1);">
                                        <span style="font-family:var(--wp--preset--font-family--display);font-weight:400;font-size:clamp(1.75rem, 4vw, 2.75rem);line-height:1.05;letter-spacing:-0.015em;transition:color 0.4s ease, font-style 0.4s ease;">View selected work</span>
                                        <span style="display:flex;flex-direction:column;align-items:flex-end;gap:0.4rem;">
                                                <span class="is-style-atelier-label" style="font-family:var(--wp--preset--font-family--body);font-size:0.6875rem;letter-spacing:0.18em;text-transform:uppercase;color:var(--atelier-muted);font-weight:500;">Archive</span>
                                                <span aria-hidden="true" style="font-family:var(--wp--preset--font-family--display);font-style:italic;font-size:clamp(1.5rem, 3vw, 2rem);color:var(--atelier-muted);transition:transform 0.4s cubic-bezier(0.2, 0.8, 0.2, 1), color 0.4s ease;">→</span>
                                        </span>
                                </a>
                        </nav>
                        <style>
                                .wp-block-godevs-demo-atelier .atelier-404-nav a:hover,
                                .wp-block-godevs-demo-atelier .atelier-404-nav a:focus-visible {
                                        padding-left: 1rem;
                                        padding-right: 1rem;
                                        outline: none;
                                }
                                .wp-block-godevs-demo-atelier .atelier-404-nav a:hover span:first-child,
                                .wp-block-godevs-demo-atelier .atelier-404-nav a:focus-visible span:first-child {
                                        color: var(--atelier-accent);
                                        font-style: italic;
                                }
                                .wp-block-godevs-demo-atelier .atelier-404-nav a:hover [aria-hidden="true"],
                                .wp-block-godevs-demo-atelier .atelier-404-nav a:focus-visible [aria-hidden="true"] {
                                        transform: translateX(6px);
                                        color: var(--atelier-accent);
                                }
                                @media (min-width: 800px) {
                                        .wp-block-godevs-demo-atelier .atelier-404-nav { grid-template-columns: 1fr 1fr !important; gap: 0 !important; }
                                        .wp-block-godevs-demo-atelier .atelier-404-nav a { border-bottom: 1px solid var(--atelier-line) !important; }
                                        .wp-block-godevs-demo-atelier .atelier-404-nav a:first-child { border-right: 1px solid var(--atelier-line); padding-right: 2.5rem !important; }
                                        .wp-block-godevs-demo-atelier .atelier-404-nav a:last-child { padding-left: 2.5rem !important; }
                                }
                                @media (prefers-reduced-motion: reduce) {
                                        .wp-block-godevs-demo-atelier .atelier-404-nav a,
                                        .wp-block-godevs-demo-atelier .atelier-404-nav a span,
                                        .wp-block-godevs-demo-atelier .atelier-404-nav a [aria-hidden="true"] {
